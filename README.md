...
An interactive visualization of the active walker model. Helbing, Keltsch, and Molnar we inspired from models of structure formation in physical, chemical, and biological systems, and applied it to pedestrials as a tool for urban planning. 
